    ...
    window.addEventListener("keydown", function(e){
        switch( e.keyCode ) {
            ...
            case 56:	// 8: from beside the car
                ...
                break;
            case 57:	// 9: from a roof
                view = 9;
                document.getElementById("Viewpoint").innerHTML = "9: Horfa frá þaki húss";
                break;
            case 48:	// 8: from beside the car
                view = 0;
                document.getElementById("Viewpoint").innerHTML = "0: Horfa frá þaki húss";
                break;
...
function render()
{
  ...
  case 0:
      ...
      var mv = lookAt( vec3(userX, 140, height+5), vec3(spinX, 0.0, 0.0), vec3(0.0, 0.0, 1.0 ) );
